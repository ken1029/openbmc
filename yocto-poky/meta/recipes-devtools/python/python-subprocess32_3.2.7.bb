DESCRIPTION = "A backport of the subprocess module from Python 3.2/3.3 for use 2.x."
HOMEPAGED = "https://github.com/google/python-subprocess32"
...
inherit setuptools
RDEPENDS_${PN} = "python-core python-io python-re python-fcntl python-pickle"
